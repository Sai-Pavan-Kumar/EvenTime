        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-xl border-t border-slate-100 z-40 md:relative md:bg-transparent md:border-none md:p-0 md:backdrop-blur-none">
            <button 
              ...
              className="w-full bg-brand-primary text-white hover:bg-white hover:text-brand-primary border-2 border-transparent hover:border-[#6C47FF] px-6 py-4 rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-70 shadow-lg shadow-[#6C47FF]/25"
            >
              {isSubmitting ? (
