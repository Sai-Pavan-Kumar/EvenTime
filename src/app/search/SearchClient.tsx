...
export function SearchClient() {
  ...
  // Fetch approved events with relations matching SearchScreen.tsx
  ...
  // Calculate live dynamic counts across upcoming platform events (Today + Future)
        ...
        <div className="max-w-3xl mx-auto mb-6">
          <div className="relative flex items-center bg-white rounded-2xl border border-slate-200/80 shadow-sm transition-all focus-within:ring-4 focus-within:ring-brand-primary/10 focus-within:border-brand-primary">
            ...
            <input
              ...
              placeholder="Search events, categories, organizers, colleges..." maxLength={100}
              className="w-full bg-transparent py-4 pl-3 pr-10 text-slate-900 placeholder:text-slate-400 font-medium text-base outline-none"
              autoFocus
            />
            {keyword.length > 0 && (
              <button
          ...
          {/* Quick Filter Chips Bar matching SearchFilterRow.tsx */}
          <div className="flex items-center gap-2 overflow-x-auto py-3 no-scrollbar">
            ...
            <div className="relative shrink-0" ref={dateDropdownRef}>
              ...
              {/* Date Popover */}
              {showDateDropdown && (
                <div className="absolute left-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-100 p-4 z-40 animate-in fade-in zoom-in-95">
            ...
            <div className="relative shrink-0" ref={cityDropdownRef}>
              ...
              {/* City Popover */}
              {showCityDropdown && (
                <div className="absolute left-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-100 p-3 z-40 animate-in fade-in zoom-in-95">
                  ...
                  <input
                    ...
                    placeholder="Search city..." maxLength={50}
            ...
            <div className="relative shrink-0" ref={categoryDropdownRef}>
              ...
              {showCategoryDropdown && (
                <div className="absolute left-0 top-full mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-100 p-3 z-40 animate-in fade-in zoom-in-95">
                  <div className="flex items-center justify-between mb-2 px-1">
          ...
          {/* Active Calendar Date Banner matching HomeActiveDateBanner */}
          {selectedDate && (
            <div className="flex items-center justify-between bg-purple-50 border border-purple-200/80 rounded-2xl px-4 py-2.5 mt-2">
        ...
        {!hasActiveFilters ? (
          <div className="text-center py-16 px-4">
            ...
            <h3 className="font-heading font-bold text-xl text-slate-900 mb-2 font-['Outfit']">
              Explore Events & Opportunities
            </h3>
            <p className="text-sm text-slate-500 max-w-md mx-auto font-['Switzer',sans-serif]">
              Start typing a keyword or pick a filter pill above to discover events across India.
            </p>
          </div>
        ) : isLoading ? (
            ...
            {displayLimit < filteredEvents.length && (
              <div className="text-center mt-12">
                <button
                  ...
                  className="px-6 py-3 bg-white hover:bg-slate-50 text-slate-700 font-bold text-sm rounded-full border border-slate-200/80 shadow-sm transition-all active:scale-95"
                >
